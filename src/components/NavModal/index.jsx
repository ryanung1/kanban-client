...
function NavModal({isMenuActive, setIsMenuActive, activeBoard, setActiveBoard, boardData, setActiveColumns, setSaveChangesModal, saveChangesModal, setNextBoardId}) {
    ...
    const changeBoard = (e, board) => {
        ...
        //   }
        // }
    const activeBoardStyles = "pl-6 flex w-[90%] bg-purple text-white px-4 py-4 rounded-r-[30px] font-jakarta-medium cursor-pointer"
    const inActiveBoardStyles = "pl-6 flex w-[90%] text-grey-medium rounded-r-[30px] px-4 py-4 font-jakarta-medium hover:bg-purple-hover hover:text-white cursor-pointer"
      ...
      <>
        {isMenuActive ? (
          <div className='absolute font-jakarta'>
            <div
              className="relative flex overflow-x-hidden overflow-y-auto top-[300px] z-50 outline-none focus:outline-none"
            >
              <div className="flex justify-center items-center min-w-3/5 my-6 mx-auto max-w-3xl">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  {/*body*/}
                  <div className="relative flex flex-col space-y-2 justify-start w-full">
                    {boardData.map((b, i) =>                     
                            <div onClick={(e) => changeBoard(e, b)} className={b["board_id"] == activeBoard["board_id"] ? activeBoardStyles : inActiveBoardStyles} id={b["board_id"]} key={i}>
                                ...
                                <p className='pl-4 text-left'>{b["board_name"]}</p>
                            </div>) 
                    }
